-- Simple debug script to identify the customer count discrepancy
-- Using only basic columns that we know exist
...
-- Let's see the actual customers data (only id and email)
