-- Simple setup for pickup_requests table to work with existing customers table
-- This avoids complex foreign key checks and just sets up what we need
...
-- Step 2: Drop and recreate foreign key constraint to customers table
