-- EcoWasteGo Database Schema (Ultra Safe Version)
-- Run this in Supabase SQL Editor
-- This version handles existing tables, policies, triggers, and functions gracefully
...
BEGIN
    ...
    DROP POLICY IF EXISTS "Users can create their own collections" ON waste_collections;
    DROP POLICY IF EXISTS "Users can update their own collections" ON waste_collections;
    
    -- Payments policies
    DROP POLICY IF EXISTS "Users can view their own payments" ON payments;
    DROP POLICY IF EXISTS "Users can create payments for their collections" ON payments;
    ...
    DROP POLICY IF EXISTS "Users can view weight entries for their collections" ON weight_entries;
    DROP POLICY IF EXISTS "Recyclers can create weight entries" ON weight_entries;
    ...
    DROP POLICY IF EXISTS "Users can update their own preferences" ON customer_preferences;
    DROP POLICY IF EXISTS "Users can insert their own preferences" ON customer_preferences;
    ...
    DROP POLICY IF EXISTS "Recyclers can view own tracking sessions" ON tracking_sessions;
    DROP POLICY IF EXISTS "Customers can view own pickup tracking" ON tracking_sessions;
    DROP POLICY IF EXISTS "Recyclers can insert own tracking sessions" ON tracking_sessions;
    DROP POLICY IF EXISTS "Recyclers can update own tracking sessions" ON tracking_sessions;
    
    -- Recycler registrations policies
    DROP POLICY IF EXISTS "Users can view their own registrations" ON recycler_registrations;
    DROP POLICY IF EXISTS "Users can insert their own registrations" ON recycler_registrations;
    DROP POLICY IF EXISTS "Users can update their own pending registrations" ON recycler_registrations;
    
    -- Request rejections policies
    DROP POLICY IF EXISTS "Recyclers can view their own rejections" ON request_rejections;
    DROP POLICY IF EXISTS "Recyclers can insert their own rejections" ON request_rejections;
    
    -- Email verifications policies
    DROP POLICY IF EXISTS "Users can view their own verification records" ON email_verifications;
    DROP POLICY IF EXISTS "Users can insert their own verification records" ON email_verifications;
    DROP POLICY IF EXISTS "Users can delete their own verification records" ON email_verifications;
    
    -- Chat messages policies
    DROP POLICY IF EXISTS "Users can view messages for their pickups" ON chat_messages;
    DROP POLICY IF EXISTS "Users can send messages for their pickups" ON chat_messages;
    ...
    DROP POLICY IF EXISTS "Users can create reviews for their collections" ON reviews;
    ...
    DROP POLICY IF EXISTS "Users can send messages for their tickets" ON support_messages;
