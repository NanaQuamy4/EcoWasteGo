...
-- NOTE: Run fix_notifications_type_constraint.sql first if you get constraint errors
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        RAISE NOTICE 'Added related_request_id column';
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        RAISE NOTICE 'Added related_user_id column';
    END IF;
...
-- Step 3: Create function to send notification to user
...
-- Step 4: Create function to send request confirmation notifications
...
-- Step 5: Create function to send request status change notifications
...
-- Step 6: Create trigger to automatically send notifications on status changes
...
-- Step 8: Create function to get user notifications
...
-- Step 9: Create function to mark notification as read
...
-- Step 10: Create function to get unread notification count
...
-- Step 12: Enable real-time for notifications (if not already enabled)
DO $$
BEGIN
...
-- Step 13: Test the notification system
