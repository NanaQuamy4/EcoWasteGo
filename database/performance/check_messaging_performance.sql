-- Database Performance Analysis for Real-Time Messaging System
-- This script checks the performance and optimization of the messaging system

-- 1. Check table structure and indexes
SELECT 
