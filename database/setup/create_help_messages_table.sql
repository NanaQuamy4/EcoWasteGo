-- Create help messages table for admin support system
-- This table stores help messages from users to admins
...
CREATE INDEX IF NOT EXISTS idx_help_messages_user_id ON help_messages(user_id);
...
CREATE INDEX IF NOT EXISTS idx_help_messages_priority ON help_messages(priority);
...
-- Admins can view and update all help messages
...
-- Create RPC function to get help messages for admin
...
-- Create RPC function to respond to help message
...
BEGIN
    ...
    SELECT 
        user_id,
        'Support Response',
        'Your support request has been responded to. Check your help messages for details.',
        'support',
        false,
        NOW()
    FROM help_messages 
...
SELECT 'Help messages table and functions created successfully!' as status;
