-- Complete Weight Entry Database Setup
-- This script sets up all required tables and functions for the weight entry system
-- Run this in your Supabase SQL editor

-- 1. Create waste_collection_details table
...
-- 3. Create collection_photos table
...
-- 9. Create pricing calculation function
...
-- 10. Create collection creation function
...
-- 13. Insert default pricing rates
...
-- 15. Create collection summary view
...
BEGIN
    ...
    RAISE NOTICE 'Tables created: waste_collection_details, pricing_rates, collection_photos';
    RAISE NOTICE 'Functions created: calculate_collection_pricing, create_waste_collection';
    RAISE NOTICE 'View created: collection_summary';
    RAISE NOTICE 'Default pricing rates inserted for all waste types and quality levels';
