...
-- Use table aliases to avoid conflicts between variable names and column names
...
-- Also fix the create_waste_collection function
...
DO $$
BEGIN
    RAISE NOTICE '✅ Fixed ambiguous column references using table aliases!';
    RAISE NOTICE 'The calculate_collection_pricing function should now work correctly.';
    RAISE NOTICE 'Test the function with: SELECT calculate_collection_pricing(''plastic'', ''good'', 5.0);';
END $$;
