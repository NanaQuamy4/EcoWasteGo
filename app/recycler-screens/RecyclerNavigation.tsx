...
export default function RecyclerNavigation() {
  ...
  const handleTextUser = () => {
            router.push('/recycler-screens/RecyclerTextUserScreen' as any);
  };
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.mapContainer}>
          <View style={styles.mapHeader}>
            ...
            <Text style={styles.mapSubtitle}>Turn-by-turn navigation</Text>
          </View>
          ...
          <MapComponent
            markers={[
              ...
              },
              {
                ...
                description: 'Gold hostel - Komfo Anokye',
                type: 'destination',
              },
            ]}
            route={{
