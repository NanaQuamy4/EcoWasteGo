-- =====================================================
-- DYNAMIC FIX FOR ADMIN FUNCTIONS - HANDLE MIXED TYPES
-- =====================================================

-- The database has mixed types - some TEXT, some VARCHAR
-- Let's use a more flexible approach with explicit casting
